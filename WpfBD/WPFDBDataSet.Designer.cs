...
SELECT ID_Person, FirstName, LastName, Age FROM Person WHERE (ID_Person = @ID_Person)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Person] ([FirstName], [LastName], [Age]) VALUES (@FirstName, @" +
                "LastName, @Age);\r\n";
        ...
        public virtual int InsertQuery(string FirstName, string LastName, int Age) {
